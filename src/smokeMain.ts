...
export class SmokeMain
{
    ...
    public debugButton?: HTMLDivElement;
    ...
    public SetupGMElements()
    {
        ...
        this.debugButton = document.getElementById("debug_button") as HTMLDivElement;
    ...
    public async Start(role: "GM" | "PLAYER")
    {
        ...
        console.log("SceneCacheReady_Ready??");
        if (sceneCache.ready)
        {
            await InitializeScene();
            console.log("SceneCacheReady_Ready_Compute");
...
export const SMOKEMAIN = new SmokeMain();
OBR.onReady(async () =>
{
