import{n as e}from"./rolldown-runtime-xNPNHALf.js";import{d as t}from"./icons-vendor-BpXzVROX.js";import{d as n}from"./react-vendor-BMLPjHd5.js";import{r}from"./motion-vendor-DDi9iG0R.js";import{n as i}from"./style-vendor-D1g7eVte.js";import{s as a}from"./main-BP3fxcPb.js";var o=e(t(),1),s=n(),c=r(),l=i.span`
  display: inline-flex;
  align-items: center;
`,u=i.span`
  position: fixed;
  ...
  &::before {
    ...
    ${e=>e.$placement===`bottom`?`border-bottom: 6px solid ${a(e.theme.BACKGROUND,.96)};`:`border-top: 6px solid ${a(e.theme.BACKGROUND,.96)};`}
  }
`,d=i.span`
  display: inline-flex;
  align-items: center;
