import{n as e}from"./rolldown-runtime-Bi-iO8vQ.js";import{a as t,c as n,d as r,l as i,s as a}from"./icons-vendor-B_eIY2Jz.js";import"./react-vendor-B73401G9.js";import{d as o,g as s,h as c}from"./obr-vendor-C3bwD0JM.js";import{r as l,t as u}from"./motion-vendor-BNb6luHb.js";import"./state-vendor-CYhUp1z0.js";import"./BSConstants-B9xxLN8d.js";import{n as d,t as f}from"./BSCache-BxqOfeuy.js";import"./SmokeMetrics-5WIKUN4a.js";import"./vendor-_0NamB6B.js";import{n as p}from"./Translation-DhiQCBW4.js";import{l as m}from"./ItemFilters-shoGtSUv.js";import{n as h,r as g}from"./ThemeContext-BKlw7sqx.js";import{n as _}from"./style-vendor-Wr67SRHu.js";import{c as v,p as y}from"./SharedStyledComponents-C4tNAqhX.js";import{t as b}from"./ToggleControl-D6eDvo80.js";import{t as x}from"./SettingsTooltip-WfdLhV86.js";import{t as ee}from"./MainPageTooltipContent-By5nFAH3.js";import{n as S,t as C}from"./MetadataKeys-Ga6bD9ll.js";var w=e(r(),1),T=l(),E=[0,15,30,45,60,75,90],D=(e,t,n,r)=>{let i=(r-90)*Math.PI/180;return{x:e+n*Math.cos(i),y:t+n*Math.sin(i)}},O=(e,t,n,r,i,a)=>{let o=D(e,t,n,i),s=D(e,t,n,a),c=D(e,t,r,a),l=D(e,t,r,i),u=a-i>180?1:0;return[`M ${o.x} ${o.y}`,`A ${n} ${n} 0 ${u} 1 ${s.x} ${s.y}`,`L ${c.x} ${c.y}`,`A ${r} ${r} 0 ${u} 0 ${l.x} ${l.y}`,`Z`].join(` `)},k=_.div`
  position: relative;
  display: inline-flex;
  align-items: center;
...
`;const re=({value:e,onChange:t,min:r=0,max:a=99,step:o=1,accent:s=g.OFFSET})=>{let{t:c}=p(),[l,u]=(0,w.useState)(!1),[d,f]=(0,w.useState)(String(e)),[m,h]=(0,w.useState)(e),_=(0,w.useRef)(null),v=String(a).length;(0,w.useEffect)(()=>{h(e)},[e]);let y=e=>{let t=Math.min(a,Math.max(r,e)),n=Math.round(t/o)*o,i=(o.toString().split(`.`)[1]||``).length;return parseFloat(n.toFixed(i))},b=e=>{t(y(parseFloat(e)||0)),u(!1)},x=t=>{l||(t.currentTarget.setPointerCapture(t.pointerId),_.current={startY:t.clientY,startVal:e,currentVal:e,moved:!1})},ee=e=>{if(!_.current)return;let t=_.current.startY-e.clientY;if(Math.abs(t)>4&&(_.current.moved=!0),!_.current.moved)return;let n=Math.round(t/6),r=y(_.current.startVal+n*o);r!==_.current.currentVal&&(_.current.currentVal=r,h(r))},S=()=>{if(!_.current)return;let n=_.current.moved,r=_.current.currentVal;_.current=null,n?(r!==e&&t(r),f(String(r)),h(r)):(f(String(e)),u(!0))},C=(n,r)=>{r.stopPropagation(),t(y(e+n*o))};return(0,T.jsxs)(N,{onPointerDown:x,onPointerMove:ee,onPointerUp:S,children:[(0,T.jsx)(P,{$fillPct:(m-r)/(a-r)*100,$accent:s}),l?(0,T.jsx)(I,{autoFocus:!0,value:d,onChange:e=>{let t=e.target.value;(t.match(/\./g)||[]).length>1&&(t=t.replace(/\.(?=.*\.)/g,``)),f(t.replace(/[^\d.]/g,``).slice(0,v+1))},onBlur:()=>b(d),onKeyDown:e=>{e.key===`Enter`&&b(d),e.key===`Escape`&&u(!1)},inputMode:`decimal`}):(0,T.jsxs)(T.Fragment,{children:[(0,T.jsx)(F,{children:Number(m.toFixed(3))}),(0,T.jsx)(L,{$position:`top`,onPointerDown:e=>e.stopPropagation(),onClick:e=>C(1,e),"aria-label":c(`common.increase`),children:(0,T.jsx)(n,{size:8})}),(0,T.jsx)(L,{$position:`bottom`,onPointerDown:e=>e.stopPropagation(),onClick:e=>C(-1,e),"aria-label":c(`common.decrease`),children:(0,T.jsx)(i,{size:8})})]})]})};var ie=_.div`
